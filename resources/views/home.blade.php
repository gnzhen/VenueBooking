...
<div class="container">
    ...
    <div class="panel-body">
    	<button class="btn btn-primary"><a href="{{ URL::route('request.create')}}" style="color:white; ">New Booking</a></button>
							...
							<td>
								...
								<td>
									<button class="btn btn-success btn-sm">
										<a href="{{ URL::route('request.show', ['id' => $request->id]) }}" style="color:white;">View
										</a>
									</button>
								</td>
						</tr>
